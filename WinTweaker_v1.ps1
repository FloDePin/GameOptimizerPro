...
function New-TweakRow {
    ...
    $name = $Tweak.Name
    $btn.Add_Click({
        [System.Windows.MessageBox]::Show($desc, "ℹ️  $name", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Information)
    })
...
$BtnOpenLog.Add_Click({
    ...
    else { [System.Windows.MessageBox]::Show("No log file yet. Apply some tweaks first.", "Log", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Information) }
})
